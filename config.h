...
static unsigned int baralpha        = 0;
...
static const Rule rules[] = {
	/* xprop(1):
	 *	WM_CLASS(STRING) = instance, classArmCord
...
static const char *const autostart[] = {
	"bash", "-c", "/home/grr/dwm/autostart.sh", NULL,
	NULL
};
...
static const char *browser[]  = { "/home/grr/thorium/thorium", NULL };
